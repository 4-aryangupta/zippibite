...
// Skipped when window.__reactCursorActive is true:
// the React <CustomCursor> component owns the elements
// and runs its own RAF animation loop.
// ═══════════════════════════════════════════════════
(function initCursor() {
  // Yield to React's CustomCursor component when running inside React app
  if (window.__reactCursorActive) return;
